...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/c3-v8.3-blue">
...
| `brace_style` | The brace style to use: `ALLMAN` or `K&R` or `C_K&R`(Classic K&R with function's opening brace on newline). | `ALLMAN` |
